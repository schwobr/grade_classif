...
__all__ = ['DeterministicHSV', 'DeterministicBrightnessContrast', 'DeterministicGamma', 'DeterministicRGBShift',
           'RGB2H', 'RGB2E', 'RGB2HEG', 'RandomCropResizeStack', 'CenterCropResizeStack', 'get_transforms1',
           'get_transforms2', 'get_transforms3', 'get_transforms4', 'get_transforms5', 'get_transforms10']
...
def get_transforms5(
    ...
    tfms = [
        ...
        Transpose(),
        RandomGamma(),
        HueSaturationValue(40, 0.1, 0.1, p=1),
    ]
    val_tfms = [
        CenterCrop(size, size)
    ]
