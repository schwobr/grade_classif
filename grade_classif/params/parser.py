...
_parser.add_argument('--transforms', type=int, default=TRANSFORMS, choices=[0, 1, 2, 3], help='0 means no transform, above enables use of function `get_transformX` with X the number entered.')
