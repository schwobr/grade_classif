...
__all__ = ['PROJECT', 'CSVS', 'LEVEL', 'FULL_DATA', 'DATA', 'DATA_CSV', 'MODELS', 'NORM_CSV', 'CONCEPTS',
           'CONCEPT_CLASSES', 'PATCH_CLASSES', 'OPEN_MODE', 'MODEL', 'DISCRIMINATOR', 'GPUS', 'SIZE', 'BATCH_SIZE',
           'LOSS', 'GEOMETRIC_LOSS', 'SCHED', 'REDUCTION', 'EPOCHS', 'DROPOUT', 'LR', 'WD', 'WEIGHT', 'NORMALIZER',
           'NORM_VERSION', 'NORM_VERSIONS', 'PRED_LEVELS', 'VERSIONS', 'CHECKPOINTS', 'SCAN', 'FILT', 'TRANSFORMS',
           'RESUME']
