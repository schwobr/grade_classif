...
__all__ = ['train_normalizer', 'train_classifier', 'train_rnn_attention', 'train_reargmt', 'train_FLFH',
           'train_discriminator', 'train_cancer_detector', 'train_mil_cancer_detector', 'train_mil_reargmt',
           'train_rnn_reargmt']
